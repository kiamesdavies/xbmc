...
if test ! -d "$abs_top_srcdir" ; then
  abs_top_srcdir=/root/kodi-android/tools/depends/target/libcdio-gplv3/i686-linux-android-android-21-debug
fi

if test ! -d "$top_builddir" ; then
  top_builddir=/root/kodi-android/tools/depends/target/libcdio-gplv3/i686-linux-android-android-21-debug
fi
