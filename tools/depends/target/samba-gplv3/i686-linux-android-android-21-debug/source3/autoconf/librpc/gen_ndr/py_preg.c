...
{
	struct preg_entry *object = (struct preg_entry *)pytalloc_get_ptr(py_obj);
	object->keyname = talloc_strdup(pytalloc_get_mem_ctx(py_obj), PyString_AS_STRING(value));
	return 0;
}
...
{
	struct preg_entry *object = (struct preg_entry *)pytalloc_get_ptr(py_obj);
	object->valuename = talloc_strdup(pytalloc_get_mem_ctx(py_obj), PyString_AS_STRING(value));
	return 0;
}
...
static PyObject *py_preg_entry_ndr_pack(PyObject *py_obj)
{
	...
	err = ndr_push_struct_blob(&blob, pytalloc_get_mem_ctx(py_obj), object, (ndr_push_flags_fn_t)ndr_push_preg_entry);
...
static PyMethodDef py_preg_entry_methods[] = {
	...
	{ "__ndr_unpack__", (PyCFunction)py_preg_entry_ndr_unpack, METH_VARARGS|METH_KEYWORDS, "S.ndr_unpack(class, blob, allow_remaining=False) -> None\nNDR unpack" },
...
static PyObject *py_preg_header_ndr_pack(PyObject *py_obj)
{
	...
	DATA_BLOB blob;
	enum ndr_err_code err;
	err = ndr_push_struct_blob(&blob, pytalloc_get_mem_ctx(py_obj), object, (ndr_push_flags_fn_t)ndr_push_preg_header);
	if (err != NDR_ERR_SUCCESS) {
		PyErr_SetNdrError(err);
		return NULL;
	}
...
static PyMethodDef py_preg_header_methods[] = {
	...
	{ "__ndr_unpack__", (PyCFunction)py_preg_header_ndr_unpack, METH_VARARGS|METH_KEYWORDS, "S.ndr_unpack(class, blob, allow_remaining=False) -> None\nNDR unpack" },
...
static PyObject *py_preg_file_ndr_pack(PyObject *py_obj)
{
	...
	DATA_BLOB blob;
	enum ndr_err_code err;
	err = ndr_push_struct_blob(&blob, pytalloc_get_mem_ctx(py_obj), object, (ndr_push_flags_fn_t)ndr_push_preg_file);
	if (err != NDR_ERR_SUCCESS) {
		PyErr_SetNdrError(err);
		return NULL;
	}
...
static PyMethodDef py_preg_file_methods[] = {
	...
	{ "__ndr_unpack__", (PyCFunction)py_preg_file_ndr_unpack, METH_VARARGS|METH_KEYWORDS, "S.ndr_unpack(class, blob, allow_remaining=False) -> None\nNDR unpack" },
...
static bool pack_py_decode_preg_file_args_in(PyObject *args, PyObject *kwargs, struct decode_preg_file *r)
{
	...
	r->in.file = *(struct preg_file *)pytalloc_get_ptr(py_file);
	return true;
}
