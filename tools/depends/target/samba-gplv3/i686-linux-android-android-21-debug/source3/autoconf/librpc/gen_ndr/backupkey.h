...
struct bkrp_exported_RSA_key_pair {
	...
	DATA_BLOB prime1;/* [subcontext_size(128),flag(LIBNDR_FLAG_REMAINING),subcontext(0)] */
	DATA_BLOB prime2;/* [subcontext(0),flag(LIBNDR_FLAG_REMAINING),subcontext_size(128)] */
	DATA_BLOB exponent1;/* [subcontext_size(128),flag(LIBNDR_FLAG_REMAINING),subcontext(0)] */
...
#else
 { __do_not_use_enum_bkrp_guid_to_integer=0x7FFFFFFF}
