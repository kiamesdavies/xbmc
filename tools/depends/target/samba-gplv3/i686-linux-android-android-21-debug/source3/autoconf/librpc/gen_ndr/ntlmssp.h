...
#else
 { __do_not_use_enum_ntlmssp_MessageType=0x7FFFFFFF}
...
#else
 { __do_not_use_enum_ntlmssp_WindowsMajorVersion=0x7FFFFFFF}
...
#else
 { __do_not_use_enum_ntlmssp_WindowsMinorVersion=0x7FFFFFFF}
...
#else
 { __do_not_use_enum_ntlmssp_NTLMRevisionCurrent=0x7FFFFFFF}
...
struct NEGOTIATE_MESSAGE {
	...
	const char * Workstation;/* [subcontext(0),flag(ndr_ntlmssp_negotiated_string_flags(NTLMSSP_NEGOTIATE_OEM)),relative,subcontext_size(WorkstationLen)] */
...
#else
 { __do_not_use_enum_ntlmssp_AvId=0x7FFFFFFF}
#define MsvAvEOL ( 0 )
...
struct AV_PAIR {
	...
	union ntlmssp_AvValue Value;/* [subcontext(0),subcontext_size(AvLen),switch_is(AvId)] */
}/* [flag(LIBNDR_FLAG_NOALIGN),public] */;

struct AV_PAIR_LIST {
	uint32_t count;
	struct AV_PAIR *pair;
}/* [nopull,flag(LIBNDR_FLAG_NOALIGN),nopush,gensize] */;
...
struct AUTHENTICATE_MESSAGE {
	...
	union ntlmssp_LM_RESPONSE *LmChallengeResponse;/* [subcontext_size(LmChallengeResponseLen),switch_is(LmChallengeResponseLen),relative,subcontext(0)] */
	uint16_t NtChallengeResponseLen;
	uint16_t NtChallengeResponseMaxLen;/* [value(NtChallengeResponseLen)] */
	union ntlmssp_NTLM_RESPONSE *NtChallengeResponse;/* [subcontext(0),relative,switch_is(NtChallengeResponseLen),subcontext_size(NtChallengeResponseMaxLen)] */
	uint16_t DomainNameLen;/* [value(ndr_ntlmssp_string_length(NegotiateFlags,DomainName))] */
	uint16_t DomainNameMaxLen;/* [value(DomainNameLen)] */
	const char * DomainName;/* [subcontext(0),flag(ndr_ntlmssp_negotiated_string_flags(r->NegotiateFlags)),subcontext_size(DomainNameLen),relative] */
	uint16_t UserNameLen;/* [value(ndr_ntlmssp_string_length(NegotiateFlags,UserName))] */
	uint16_t UserNameMaxLen;/* [value(UserNameLen)] */
	const char * UserName;/* [subcontext_size(UserNameLen),relative,subcontext(0),flag(ndr_ntlmssp_negotiated_string_flags(r->NegotiateFlags))] */
	uint16_t WorkstationLen;/* [value(ndr_ntlmssp_string_length(NegotiateFlags,Workstation))] */
	uint16_t WorkstationMaxLen;/* [value(WorkstationLen)] */
	const char * Workstation;/* [flag(ndr_ntlmssp_negotiated_string_flags(r->NegotiateFlags)),subcontext(0),subcontext_size(WorkstationLen),relative] */
