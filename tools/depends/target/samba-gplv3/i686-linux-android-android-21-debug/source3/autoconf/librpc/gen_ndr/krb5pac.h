...
}/* [public,nodiscriminant,gensize] */;

struct PAC_BUFFER {
	enum PAC_TYPE type;
	uint32_t _ndr_size;/* [value(_ndr_size_PAC_INFO(info,type,0))] */
	union PAC_INFO *info;/* [relative,subcontext_size(_subcontext_size_PAC_INFO(r,ndr->flags)),switch_is(type),flag(LIBNDR_FLAG_ALIGN8),subcontext(0)] */
	uint32_t _pad;/* [value(0)] */
}/* [nopush,nopull,noprint,public] */;
