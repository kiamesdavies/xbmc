...
staticforward PyTypeObject dns_rp_record_Type;
...
void initdns(void);static PyTypeObject *dnsp_hinfo_Type;
...
static int py_dns_rp_record_set_mbox(PyObject *py_obj, PyObject *value, void *closure)
{
	...
	object->mbox = talloc_strdup(pytalloc_get_mem_ctx(py_obj), PyString_AS_STRING(value));
	return 0;
}
...
{
	struct dns_rp_record *object = (struct dns_rp_record *)pytalloc_get_ptr(py_obj);
	object->txt = talloc_strdup(pytalloc_get_mem_ctx(py_obj), PyString_AS_STRING(value));
	return 0;
}

static PyGetSetDef py_dns_rp_record_getsetters[] = {
	{ discard_const_p(char, "mbox"), py_dns_rp_record_get_mbox, py_dns_rp_record_set_mbox },
	{ discard_const_p(char, "txt"), py_dns_rp_record_get_txt, py_dns_rp_record_set_txt },
	{ NULL }
};
...
static PyObject *py_dns_rp_record_ndr_pack(PyObject *py_obj)
{
	...
	DATA_BLOB blob;
	enum ndr_err_code err;
	err = ndr_push_struct_blob(&blob, pytalloc_get_mem_ctx(py_obj), object, (ndr_push_flags_fn_t)ndr_push_dns_rp_record);
	if (err != NDR_ERR_SUCCESS) {
		PyErr_SetNdrError(err);
		return NULL;
	}
...
static PyMethodDef py_dns_rp_record_methods[] = {
	...
	{ "__ndr_print__", (PyCFunction)py_dns_rp_record_ndr_print, METH_VARARGS, "S.ndr_print(object) -> None\nNDR print" },
	{ NULL, NULL, 0, NULL }
};
...
void initdns(void)
{
	...
	dns_rp_record_Type.tp_base = Object_Type;
