						     ...
						     WERROR *result)
{
	...
	/* Out parameters */
	r.out.ORPCthat = _ORPCthat;
	r.out.unknown3 = _unknown3;
	r.out.iface2 = _iface2;
		       ...
		       WERROR *result)
{
	...
	/* Out parameters */
	r.out.ORPCthat = _ORPCthat;
	r.out.pDispParams = _pDispParams;
	r.out.pVarResult = _pVarResult;
	r.out.pExcepInfo = _pExcepInfo;
	r.out.puArgErr = _puArgErr;
