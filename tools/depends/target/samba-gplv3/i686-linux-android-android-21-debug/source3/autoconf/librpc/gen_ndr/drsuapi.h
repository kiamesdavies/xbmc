...
union drsuapi_DsBindInfo {
	struct drsuapi_DsBindInfo24 info24;/* [case(24),subcontext_size(24),subcontext(0)] */
	struct drsuapi_DsBindInfo28 info28;/* [subcontext(0),subcontext_size(28),case(28)] */
	struct drsuapi_DsBindInfo32 info32;/* [subcontext(0),subcontext_size(32),case(32)] */
	struct drsuapi_DsBindInfo48 info48;/* [subcontext(0),case(48),subcontext_size(48)] */
	struct drsuapi_DsBindInfo52 info52;/* [subcontext_size(52),case(52),subcontext(0)] */
	struct drsuapi_DsBindInfoFallBack Fallback;/* [default,subcontext(0),subcontext_size(48)] */
}/* [nopush,noprint,nopull,nodiscriminant] */;
...
struct drsuapi_DsReplicaObjectIdentifier {
	...
	const char *dn;/* [size_is(__ndr_size_dn+1),charset(UTF16)] */
}/* [gensize,public] */;
...
struct drsuapi_DsReplicaSyncRequest1 {
	...
	const char *source_dsa_dns;/* [unique,charset(DOS)] */
	uint32_t options;
};
...
struct drsuapi_DsAttributeValue {
	uint32_t __ndr_size;/* [value(ndr_size_DATA_BLOB(0,blob,0)),range(0,26214400)] */
...
struct drsuapi_DsGetNCChangesMSZIPCtr1 {
	...
	struct drsuapi_DsGetNCChangesCtr1TS *ts;/* [subcontext(4),unique,subcontext_size(compressed_length),compression(NDR_COMPRESSION_MSZIP,compressed_length,decompressed_length)] */
}/* [nopush] */;

struct drsuapi_DsGetNCChangesMSZIPCtr6 {
	uint32_t decompressed_length;
	uint32_t compressed_length;
	struct drsuapi_DsGetNCChangesCtr6TS *ts;/* [compression(NDR_COMPRESSION_MSZIP,compressed_length,decompressed_length),subcontext_size(compressed_length),subcontext(4),unique] */
}/* [nopush] */;

struct drsuapi_DsGetNCChangesXPRESSCtr1 {
	uint32_t decompressed_length;
	uint32_t compressed_length;
	struct drsuapi_DsGetNCChangesCtr1TS *ts;/* [compression(NDR_COMPRESSION_XPRESS,compressed_length,decompressed_length),subcontext_size(compressed_length),unique,subcontext(4)] */
}/* [nopush] */;

struct drsuapi_DsGetNCChangesXPRESSCtr6 {
	uint32_t decompressed_length;
	uint32_t compressed_length;
	struct drsuapi_DsGetNCChangesCtr6TS *ts;/* [compression(NDR_COMPRESSION_XPRESS,compressed_length,decompressed_length),subcontext_size(compressed_length),unique,subcontext(4)] */
}/* [nopush] */;
...
struct drsuapi_DsReplicaDelRequest1 {
	struct drsuapi_DsReplicaObjectIdentifier *naming_context;/* [ref] */
	const char *source_dsa_address;/* [unique,charset(UTF8)] */
	uint32_t options;
};
...
struct drsuapi_QuerySitesByCostRequest1 {
	...
	uint32_t num_req;/* [range(1,10000)] */
	const char **site_to;/* [size_is(num_req),charset(UTF16),unique] */
	uint32_t flags;
};
...
struct drsuapi_DsReplicaSync {
	struct {
		struct policy_handle *bind_handle;/* [ref] */
		uint32_t level;
		union drsuapi_DsReplicaSyncRequest *req;/* [switch_is(level),ref] */
	} in;
...
struct drsuapi_DsCrackNames {
	struct {
		struct policy_handle *bind_handle;/* [ref] */
		uint32_t level;
		union drsuapi_DsNameRequest *req;/* [switch_is(level),ref] */
	} in;
...
struct drsuapi_DsWriteAccountSpn {
	struct {
		struct policy_handle *bind_handle;/* [ref] */
		uint32_t level;
		union drsuapi_DsWriteAccountSpnRequest *req;/* [switch_is(level),ref] */
	} in;
...
struct drsuapi_DsRemoveDSServer {
	struct {
		struct policy_handle *bind_handle;/* [ref] */
		uint32_t level;
		union drsuapi_DsRemoveDSServerRequest *req;/* [switch_is(level),ref] */
	} in;
...
struct drsuapi_DsGetDomainControllerInfo {
	...
	struct {
		...
		union drsuapi_DsGetDCInfoCtr *ctr;/* [switch_is(*level_out),ref] */
		WERROR result;
	} out;
...
struct drsuapi_QuerySitesByCost {
	struct {
		struct policy_handle *bind_handle;/* [ref] */
		uint32_t level;
		union drsuapi_QuerySitesByCostRequest *req;/* [switch_is(level),ref] */
	} in;
