...
struct lsa_StringLarge {
	...
	const char *string;/* [size_is(size/2),charset(UTF16),unique,length_is(length/2)] */
}/* [public] */;
...
struct lsa_AsciiString {
	...
	const char *string;/* [size_is(size),charset(DOS),unique,length_is(length)] */
}/* [public] */;

struct lsa_AsciiStringLarge {
	uint16_t length;/* [value(strlen_m(string))] */
	uint16_t size;/* [value(strlen_m_term(string))] */
	const char *string;/* [charset(DOS),unique,length_is(length),size_is(size)] */
}/* [public] */;

struct lsa_BinaryString {
	uint16_t length;
	uint16_t size;
	uint16_t *array;/* [size_is(size/2),length_is(length/2),unique] */
}/* [public] */;
...
struct lsa_DATA_BUF {
	uint32_t length;
	uint32_t size;
	uint8_t *data;/* [size_is(size),length_is(length),unique] */
