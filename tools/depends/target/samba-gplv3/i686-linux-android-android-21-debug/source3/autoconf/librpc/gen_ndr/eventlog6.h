...
#else
 { __do_not_use_enum_eventlog6_EvtRpcVariantType=0x7FFFFFFF}
...
#else
 { __do_not_use_enum_eventlog6_EvtRpcAssertConfigFlags=0x7FFFFFFF}
...
struct eventlog6_EvtRpcRegisterRemoteSubscription {
	struct {
		const char *channelPath;/* [charset(UTF16),unique,range(0,MAX_RPC_CHANNEL_NAME_LENGTH)] */
	...
	struct {
		...
		struct eventlog6_EvtRpcQueryChannelInfo **queryChannelInfo;/* [ref,size_is(,*queryChannelInfoSize),range(0,MAX_RPC_QUERY_CHANNEL_SIZE)] */
...
struct eventlog6_EvtRpcRemoteSubscriptionNextAsync {
	...
	struct {
		...
		uint8_t **resultBuffer;/* [range(0,MAX_RPC_BATCH_SIZE),ref,size_is(,*resultBufferSize)] */
		WERROR result;
	} out;
...
struct eventlog6_EvtRpcRegisterLogQuery {
	struct {
		const char *path;/* [range(0,MAX_RPC_CHANNEL_PATH_LENGTH),unique,charset(UTF16)] */
		const char *query;/* [range(1,MAX_RPC_QUERY_LENGTH),charset(UTF16),ref] */
		uint32_t flags;
	} in;
...
struct eventlog6_EvtRpcClearLog {
	struct {
		struct policy_handle *control;/* [ref] */
		const char *channelPath;/* [charset(UTF16),range(0,MAX_RPC_CHANNEL_NAME_LENGTH),ref] */
		const char *backupPath;/* [range(0,MAX_RPC_FILE_PATH_LENGTH),unique,charset(UTF16)] */
		uint32_t flags;
	} in;
...
struct eventlog6_EvtRpcExportLog {
	struct {
		...
		const char *channelPath;/* [charset(UTF16),unique,range(0,MAX_RPC_CHANNEL_NAME_LENGTH)] */
		const char *query;/* [range(1,MAX_RPC_QUERY_LENGTH),charset(UTF16),ref] */
		const char *backupPath;/* [charset(UTF16),range(1,MAX_RPC_FILE_PATH_LENGTH),ref] */
		uint32_t flags;
	} in;
...
struct eventlog6_EvtRpcMessageRenderDefault {
	...
	struct {
		uint32_t *actualSizeString;/* [ref] */
		uint32_t *neededSizeString;/* [ref] */
		uint8_t **string;/* [range(0,MAX_RPC_RENDERED_STRING_SIZE),ref,size_is(,*actualSizeString)] */
		struct eventlog6_RpcInfo *error;/* [ref] */
		WERROR result;
	} out;
...
struct eventlog6_EvtRpcQueryNext {
	...
	struct {
		uint32_t *numActualRecords;/* [ref] */
		uint32_t **eventDataIndices;/* [range(0,MAX_RPC_RECORD_COUNT),ref,size_is(,*numActualRecords)] */
...
struct eventlog6_EvtRpcAssertConfig {
	struct {
		const char *path;/* [charset(UTF16),range(1,MAX_RPC_CHANNEL_NAME_LENGTH),ref] */
		uint32_t flags;
	} in;
...
struct eventlog6_EvtRpcRetractConfig {
	struct {
		const char *path;/* [ref,charset(UTF16),range(1,MAX_RPC_CHANNEL_NAME_LENGTH)] */
		uint32_t flags;
	} in;
...
struct eventlog6_EvtRpcOpenLogHandle {
	struct {
		const char *channel;/* [range(1,MAX_RPC_CHANNEL_NAME_LENGTH),charset(UTF16),ref] */
		uint32_t flags;
	} in;
...
struct eventlog6_EvtRpcGetChannelList {
	...
	struct {
		...
		const char ***channelPaths;/* [charset(UTF16),range(0,MAX_RPC_CHANNEL_COUNT),size_is(,*numChannelPaths),ref] */
		WERROR result;
	} out;
...
struct eventlog6_EvtRpcPutChannelConfig {
	struct {
		const char *channelPath;/* [range(1,MAX_RPC_CHANNEL_NAME_LENGTH),charset(UTF16),ref] */
		uint32_t flags;
		struct eventlog6_EvtRpcVariantList *props;/* [ref] */
	} in;
...
struct eventlog6_EvtRpcGetPublisherList {
	...
	struct {
		...
		const char ***publisherIds;/* [size_is(,*numPublisherIds),ref,charset(UTF16),range(0,MAX_RPC_PUBLISHER_COUNT)] */
		WERROR result;
	} out;
...
struct eventlog6_EvtRpcGetPublisherListForChannel {
	...
	struct {
		uint32_t *numPublisherIds;/* [ref] */
		const char ***publisherIds;/* [range(0,MAX_RPC_PUBLISHER_COUNT),charset(UTF16),ref,size_is(,*numPublisherIds)] */
		WERROR result;
	} out;
...
struct eventlog6_EvtRpcGetPublisherMetadata {
	struct {
		...
		const char *logFilePath;/* [range(0,MAX_RPC_FILE_PATH_LENGTH),charset(UTF16),unique] */
		uint32_t locale;
		uint32_t flags;
	} in;
...
struct eventlog6_EvtRpcGetNextEventMetadata {
	...
	struct {
		...
		struct eventlog6_EvtRpcVariantList **eventMetadataInstances;/* [size_is(,*numReturned),ref,range(0,MAX_RPC_EVENT_METADATA_COUNT)] */
		WERROR result;
	} out;
...
struct eventlog6_EvtRpcGetClassicLogDisplayName {
	struct {
		const char *logName;/* [range(1,MAX_RPC_CHANNEL_NAME_LENGTH),charset(UTF16),ref] */
		uint32_t locale;
		uint32_t flags;
	} in;
