...
#else
 { __do_not_use_enum_NL_AUTH_MESSAGE_TYPE=0x7FFFFFFF}
...
#else
 { __do_not_use_enum_NL_SIGNATURE_ALGORITHM=0x7FFFFFFF}
...
#else
 { __do_not_use_enum_NL_SEAL_ALGORITHM=0x7FFFFFFF}
