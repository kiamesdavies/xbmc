					 ...
					 NTSTATUS *result)
{
	...
	/* Out parameters */
	r.out.oldest_entry = _oldest_entry;
				       ...
				       NTSTATUS *result)
{
	...
	/* Out parameters */
	r.out.data = _data;
	r.out.sent_size = _sent_size;
	r.out.real_size = _real_size;
				      ...
				      NTSTATUS *result)
{
	...
	/* Out parameters */
	r.out.record_number = _record_number;
	r.out.time_written = _time_written;
					   ...
					   NTSTATUS *result)
{
	...
	r.out.bytes_needed = _bytes_needed;
