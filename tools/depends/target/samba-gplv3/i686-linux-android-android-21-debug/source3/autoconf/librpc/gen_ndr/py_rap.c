...
{
	struct rap_group_info_1 *object = (struct rap_group_info_1 *)pytalloc_get_ptr(obj);
...
{
	struct rap_group_info_1 *object = (struct rap_group_info_1 *)pytalloc_get_ptr(py_obj);
...
{
	return pytalloc_new(struct rap_group_info_1, type);
}
...
{
	struct rap_user_info_1 *object = (struct rap_user_info_1 *)pytalloc_get_ptr(obj);
...
{
	struct rap_user_info_1 *object = (struct rap_user_info_1 *)pytalloc_get_ptr(py_obj);
	PY_CHECK_TYPE(&PyList_Type, value, return -1;);
	{
		int user_name_cntr_0;
...
static int py_rap_user_info_1_set_home_dir(PyObject *py_obj, PyObject *value, void *closure)
{
	...
	if (value == Py_None) {
		...
		object->home_dir = NULL;
		object->home_dir = talloc_strdup(pytalloc_get_mem_ctx(py_obj), PyString_AS_STRING(value));
	}
	return 0;
}
...
static int py_rap_user_info_1_set_logon_script(PyObject *py_obj, PyObject *value, void *closure)
{
	...
	if (value == Py_None) {
		...
		object->logon_script = NULL;
		object->logon_script = talloc_strdup(pytalloc_get_mem_ctx(py_obj), PyString_AS_STRING(value));
	}
	return 0;
}
...
{
	return pytalloc_new(struct rap_user_info_1, type);
}
...
{
	struct rap_service_info_2 *object = (struct rap_service_info_2 *)pytalloc_get_ptr(obj);
...
{
	struct rap_service_info_2 *object = (struct rap_service_info_2 *)pytalloc_get_ptr(py_obj);
	PY_CHECK_TYPE(&PyList_Type, value, return -1;);
	{
		int service_name_cntr_0;
...
{
	return pytalloc_new(struct rap_service_info_2, type);
}
...
{
	struct rap_share_info_0 *object = (struct rap_share_info_0 *)pytalloc_get_ptr(obj);
...
{
	struct rap_share_info_0 *object = (struct rap_share_info_0 *)pytalloc_get_ptr(py_obj);
	PY_CHECK_TYPE(&PyList_Type, value, return -1;);
	{
		int share_name_cntr_0;
...
{
	return pytalloc_new(struct rap_share_info_0, type);
}
...
{
	struct rap_share_info_1 *object = (struct rap_share_info_1 *)pytalloc_get_ptr(obj);
	PyObject *py_share_name;
	py_share_name = PyList_New(13);
	if (py_share_name == NULL) {
		return NULL;
...
{
	struct rap_share_info_1 *object = (struct rap_share_info_1 *)pytalloc_get_ptr(py_obj);
	PY_CHECK_TYPE(&PyList_Type, value, return -1;);
	{
		int share_name_cntr_0;
		for (share_name_cntr_0 = 0; share_name_cntr_0 < PyList_GET_SIZE(value); share_name_cntr_0++) {
...
{
	return pytalloc_new(struct rap_share_info_1, type);
}
...
{
	struct rap_share_info_2 *object = (struct rap_share_info_2 *)pytalloc_get_ptr(obj);
	PyObject *py_share_name;
	py_share_name = PyList_New(13);
	if (py_share_name == NULL) {
		return NULL;
...
{
	struct rap_share_info_2 *object = (struct rap_share_info_2 *)pytalloc_get_ptr(py_obj);
	PY_CHECK_TYPE(&PyList_Type, value, return -1;);
	{
		int share_name_cntr_0;
		for (share_name_cntr_0 = 0; share_name_cntr_0 < PyList_GET_SIZE(value); share_name_cntr_0++) {
...
{
	return pytalloc_new(struct rap_share_info_2, type);
}
...
PyObject *py_import_rap_share_info(TALLOC_CTX *mem_ctx, int level, union rap_share_info *in)
{
	...
	switch (level) {
		case 0:
			ret = pytalloc_reference_ex(&rap_share_info_0_Type, mem_ctx, &in->info0);
			return ret;

		case 1:
			ret = pytalloc_reference_ex(&rap_share_info_1_Type, mem_ctx, &in->info1);
			return ret;

		case 2:
			ret = pytalloc_reference_ex(&rap_share_info_2_Type, mem_ctx, &in->info2);
			return ret;
...
union rap_share_info *py_export_rap_share_info(TALLOC_CTX *mem_ctx, int level, PyObject *in)
{
	...
	switch (level) {
		case 0:
			...
			ret->info0 = *(struct rap_share_info_0 *)pytalloc_get_ptr(in);
			break;
		...
		case 1:
			...
			ret->info1 = *(struct rap_share_info_1 *)pytalloc_get_ptr(in);
			break;
		...
		case 2:
			...
			ret->info2 = *(struct rap_share_info_2 *)pytalloc_get_ptr(in);
			break;
...
{
	struct rap_server_info_0 *object = (struct rap_server_info_0 *)pytalloc_get_ptr(obj);
	PyObject *py_name;
...
{
	struct rap_server_info_0 *object = (struct rap_server_info_0 *)pytalloc_get_ptr(py_obj);
	PY_CHECK_TYPE(&PyList_Type, value, return -1;);
	{
		int name_cntr_0;
...
{
	return pytalloc_new(struct rap_server_info_0, type);
}
...
{
	struct rap_server_info_1 *object = (struct rap_server_info_1 *)pytalloc_get_ptr(obj);
	PyObject *py_name;
	py_name = PyList_New(16);
	if (py_name == NULL) {
		return NULL;
...
{
	struct rap_server_info_1 *object = (struct rap_server_info_1 *)pytalloc_get_ptr(py_obj);
	PY_CHECK_TYPE(&PyList_Type, value, return -1;);
	{
		int name_cntr_0;
		for (name_cntr_0 = 0; name_cntr_0 < PyList_GET_SIZE(value); name_cntr_0++) {
...
{
	return pytalloc_new(struct rap_server_info_1, type);
}
...
PyObject *py_import_rap_server_info(TALLOC_CTX *mem_ctx, int level, union rap_server_info *in)
{
	...
	switch (level) {
		case 0:
			ret = pytalloc_reference_ex(&rap_server_info_0_Type, mem_ctx, &in->info0);
			return ret;

		case 1:
			ret = pytalloc_reference_ex(&rap_server_info_1_Type, mem_ctx, &in->info1);
			return ret;
...
union rap_server_info *py_export_rap_server_info(TALLOC_CTX *mem_ctx, int level, PyObject *in)
{
	...
	switch (level) {
		case 0:
			...
			ret->info0 = *(struct rap_server_info_0 *)pytalloc_get_ptr(in);
			break;
		...
		case 1:
			...
			ret->info1 = *(struct rap_server_info_1 *)pytalloc_get_ptr(in);
			break;
...
{
	struct rap_PrintJobInfo0 *object = (struct rap_PrintJobInfo0 *)pytalloc_get_ptr(obj);
	PyObject *py_JobID;
...
{
	struct rap_PrintJobInfo0 *object = (struct rap_PrintJobInfo0 *)pytalloc_get_ptr(py_obj);
	PY_CHECK_TYPE(&PyInt_Type, value, return -1;);
...
{
	return pytalloc_new(struct rap_PrintJobInfo0, type);
}
...
{
	struct rap_PrintJobInfo1 *object = (struct rap_PrintJobInfo1 *)pytalloc_get_ptr(obj);
	PyObject *py_JobID;
	py_JobID = PyInt_FromLong(object->JobID);
	return py_JobID;
}
...
{
	struct rap_PrintJobInfo1 *object = (struct rap_PrintJobInfo1 *)pytalloc_get_ptr(py_obj);
	PY_CHECK_TYPE(&PyInt_Type, value, return -1;);
	object->JobID = PyInt_AsLong(value);
	return 0;
}
...
static int py_rap_PrintJobInfo1_set_PrintParameterString(PyObject *py_obj, PyObject *value, void *closure)
{
	...
	if (value == Py_None) {
		...
		object->PrintParameterString = NULL;
		object->PrintParameterString = talloc_strdup(pytalloc_get_mem_ctx(py_obj), PyString_AS_STRING(value));
	}
	return 0;
}
...
static int py_rap_PrintJobInfo1_set_JobStatusString(PyObject *py_obj, PyObject *value, void *closure)
{
	...
	if (value == Py_None) {
		...
		object->JobStatusString = NULL;
		object->JobStatusString = talloc_strdup(pytalloc_get_mem_ctx(py_obj), PyString_AS_STRING(value));
	}
	return 0;
}
...
static int py_rap_PrintJobInfo1_set_JobCommentString(PyObject *py_obj, PyObject *value, void *closure)
{
	...
	if (value == Py_None) {
		...
		object->JobCommentString = NULL;
		object->JobCommentString = talloc_strdup(pytalloc_get_mem_ctx(py_obj), PyString_AS_STRING(value));
	}
	return 0;
}
...
{
	return pytalloc_new(struct rap_PrintJobInfo1, type);
}
...
{
	struct rap_PrintJobInfo2 *object = (struct rap_PrintJobInfo2 *)pytalloc_get_ptr(obj);
	PyObject *py_JobID;
	py_JobID = PyInt_FromLong(object->JobID);
	return py_JobID;
}
...
{
	struct rap_PrintJobInfo2 *object = (struct rap_PrintJobInfo2 *)pytalloc_get_ptr(py_obj);
	PY_CHECK_TYPE(&PyInt_Type, value, return -1;);
	object->JobID = PyInt_AsLong(value);
	return 0;
}
...
static int py_rap_PrintJobInfo2_set_UserName(PyObject *py_obj, PyObject *value, void *closure)
{
	...
	if (value == Py_None) {
		...
		object->UserName = NULL;
		object->UserName = talloc_strdup(pytalloc_get_mem_ctx(py_obj), PyString_AS_STRING(value));
	}
	return 0;
}
...
static int py_rap_PrintJobInfo2_set_DocumentName(PyObject *py_obj, PyObject *value, void *closure)
{
	...
	if (value == Py_None) {
		...
		object->DocumentName = NULL;
		object->DocumentName = talloc_strdup(pytalloc_get_mem_ctx(py_obj), PyString_AS_STRING(value));
	}
	return 0;
}
...
{
	return pytalloc_new(struct rap_PrintJobInfo2, type);
}
...
{
	struct rap_PrintJobInfo3 *object = (struct rap_PrintJobInfo3 *)pytalloc_get_ptr(obj);
	PyObject *py_JobID;
	py_JobID = PyInt_FromLong(object->JobID);
	return py_JobID;
}
...
{
	struct rap_PrintJobInfo3 *object = (struct rap_PrintJobInfo3 *)pytalloc_get_ptr(py_obj);
	PY_CHECK_TYPE(&PyInt_Type, value, return -1;);
	object->JobID = PyInt_AsLong(value);
	return 0;
}
...
static int py_rap_PrintJobInfo3_set_NotifyName(PyObject *py_obj, PyObject *value, void *closure)
{
	...
	if (value == Py_None) {
		...
		object->NotifyName = NULL;
		object->NotifyName = talloc_strdup(pytalloc_get_mem_ctx(py_obj), PyString_AS_STRING(value));
	}
	return 0;
}
...
static int py_rap_PrintJobInfo3_set_StatusString(PyObject *py_obj, PyObject *value, void *closure)
{
	...
	if (value == Py_None) {
		...
		object->StatusString = NULL;
		object->StatusString = talloc_strdup(pytalloc_get_mem_ctx(py_obj), PyString_AS_STRING(value));
	}
	return 0;
}
...
static int py_rap_PrintJobInfo3_set_QueueName(PyObject *py_obj, PyObject *value, void *closure)
{
	...
	if (value == Py_None) {
		...
		object->QueueName = NULL;
		object->QueueName = talloc_strdup(pytalloc_get_mem_ctx(py_obj), PyString_AS_STRING(value));
	}
	return 0;
}
...
static int py_rap_PrintJobInfo3_set_PrintProcessorName(PyObject *py_obj, PyObject *value, void *closure)
{
	...
	if (value == Py_None) {
		...
		object->PrintProcessorName = NULL;
		object->PrintProcessorName = talloc_strdup(pytalloc_get_mem_ctx(py_obj), PyString_AS_STRING(value));
	}
	return 0;
}
...
static int py_rap_PrintJobInfo3_set_PrintProcessorParams(PyObject *py_obj, PyObject *value, void *closure)
{
	...
	if (value == Py_None) {
		...
		object->PrintProcessorParams = NULL;
		object->PrintProcessorParams = talloc_strdup(pytalloc_get_mem_ctx(py_obj), PyString_AS_STRING(value));
	}
	return 0;
}
...
static int py_rap_PrintJobInfo3_set_DriverDataOffset(PyObject *py_obj, PyObject *value, void *closure)
{
	...
	if (value == Py_None) {
		...
		object->DriverDataOffset = NULL;
		object->DriverDataOffset = talloc_strdup(pytalloc_get_mem_ctx(py_obj), PyString_AS_STRING(value));
	}
	return 0;
}
...
static int py_rap_PrintJobInfo3_set_PrinterNameOffset(PyObject *py_obj, PyObject *value, void *closure)
{
	...
	if (value == Py_None) {
		...
		object->PrinterNameOffset = NULL;
		object->PrinterNameOffset = talloc_strdup(pytalloc_get_mem_ctx(py_obj), PyString_AS_STRING(value));
	}
	return 0;
}
...
{
	return pytalloc_new(struct rap_PrintJobInfo3, type);
}
...
PyObject *py_import_rap_printj_info(TALLOC_CTX *mem_ctx, int level, union rap_printj_info *in)
{
	...
	switch (level) {
		case 0:
			ret = pytalloc_reference_ex(&rap_PrintJobInfo0_Type, mem_ctx, &in->info0);
			return ret;

		case 1:
			ret = pytalloc_reference_ex(&rap_PrintJobInfo1_Type, mem_ctx, &in->info1);
			return ret;

		case 2:
			ret = pytalloc_reference_ex(&rap_PrintJobInfo2_Type, mem_ctx, &in->info2);
			return ret;

		case 3:
			ret = pytalloc_reference_ex(&rap_PrintJobInfo3_Type, mem_ctx, &in->info3);
			return ret;
...
union rap_printj_info *py_export_rap_printj_info(TALLOC_CTX *mem_ctx, int level, PyObject *in)
{
	...
	switch (level) {
		case 0:
			...
			ret->info0 = *(struct rap_PrintJobInfo0 *)pytalloc_get_ptr(in);
			break;
		...
		case 1:
			...
			ret->info1 = *(struct rap_PrintJobInfo1 *)pytalloc_get_ptr(in);
			break;
		...
		case 2:
			...
			ret->info2 = *(struct rap_PrintJobInfo2 *)pytalloc_get_ptr(in);
			break;
		...
		case 3:
			...
			ret->info3 = *(struct rap_PrintJobInfo3 *)pytalloc_get_ptr(in);
			break;
...
{
	struct rap_PrintQueue0 *object = (struct rap_PrintQueue0 *)pytalloc_get_ptr(obj);
...
{
	struct rap_PrintQueue0 *object = (struct rap_PrintQueue0 *)pytalloc_get_ptr(py_obj);
	if (PyUnicode_Check(value)) {
...
{
	return pytalloc_new(struct rap_PrintQueue0, type);
}
...
{
	struct rap_PrintQueue1 *object = (struct rap_PrintQueue1 *)pytalloc_get_ptr(obj);
	PyObject *py_PrintQName;
	if (object->PrintQName == NULL) {
		py_PrintQName = Py_None;
		Py_INCREF(py_PrintQName);
...
{
	struct rap_PrintQueue1 *object = (struct rap_PrintQueue1 *)pytalloc_get_ptr(py_obj);
	if (PyUnicode_Check(value)) {
		object->PrintQName = PyString_AS_STRING(PyUnicode_AsEncodedString(value, "utf-8", "ignore"));
	} else if (PyString_Check(value)) {
		object->PrintQName = PyString_AS_STRING(value);
...
static int py_rap_PrintQueue1_set_SeparatorPageFilename(PyObject *py_obj, PyObject *value, void *closure)
{
	...
	if (value == Py_None) {
		...
		object->SeparatorPageFilename = NULL;
		object->SeparatorPageFilename = talloc_strdup(pytalloc_get_mem_ctx(py_obj), PyString_AS_STRING(value));
	}
	return 0;
}
...
static int py_rap_PrintQueue1_set_PrintProcessorDllName(PyObject *py_obj, PyObject *value, void *closure)
{
	...
	if (value == Py_None) {
		...
		object->PrintProcessorDllName = NULL;
		object->PrintProcessorDllName = talloc_strdup(pytalloc_get_mem_ctx(py_obj), PyString_AS_STRING(value));
	}
	return 0;
}
...
static int py_rap_PrintQueue1_set_PrintDestinationsName(PyObject *py_obj, PyObject *value, void *closure)
{
	...
	if (value == Py_None) {
		...
		object->PrintDestinationsName = NULL;
		object->PrintDestinationsName = talloc_strdup(pytalloc_get_mem_ctx(py_obj), PyString_AS_STRING(value));
	}
	return 0;
}
...
static int py_rap_PrintQueue1_set_CommentString(PyObject *py_obj, PyObject *value, void *closure)
{
	...
	if (value == Py_None) {
		...
		object->CommentString = NULL;
		object->CommentString = talloc_strdup(pytalloc_get_mem_ctx(py_obj), PyString_AS_STRING(value));
	}
	return 0;
}
...
{
	return pytalloc_new(struct rap_PrintQueue1, type);
}
...
{
	struct rap_PrintQueue2 *object = (struct rap_PrintQueue2 *)pytalloc_get_ptr(obj);
	PyObject *py_queue;
	py_queue = pytalloc_reference_ex(&rap_PrintQueue1_Type, pytalloc_get_mem_ctx(obj), &object->queue);
	return py_queue;
}

static int py_rap_PrintQueue2_set_queue(PyObject *py_obj, PyObject *value, void *closure)
{
	struct rap_PrintQueue2 *object = (struct rap_PrintQueue2 *)pytalloc_get_ptr(py_obj);
	PY_CHECK_TYPE(&rap_PrintQueue1_Type, value, return -1;);
	if (talloc_reference(pytalloc_get_mem_ctx(py_obj), pytalloc_get_mem_ctx(value)) == NULL) {
		PyErr_NoMemory();
		return -1;
	}
	object->queue = *(struct rap_PrintQueue1 *)pytalloc_get_ptr(value);
	return 0;
}
...
static PyObject *py_rap_PrintQueue2_get_job(PyObject *obj, void *closure)
{
	...
	}
	{
		...
		for (job_cntr_0 = 0; job_cntr_0 < object->queue.PrintJobCount; job_cntr_0++) {
			PyObject *py_job_0;
			py_job_0 = pytalloc_reference_ex(&rap_PrintJobInfo1_Type, object->job, &object->job[job_cntr_0]);
...
static int py_rap_PrintQueue2_set_job(PyObject *py_obj, PyObject *value, void *closure)
{
	...
	{
		int job_cntr_0;
		object->job = talloc_array_ptrtype(pytalloc_get_mem_ctx(py_obj), object->job, PyList_GET_SIZE(value));
		...
		for (job_cntr_0 = 0; job_cntr_0 < PyList_GET_SIZE(value); job_cntr_0++) {
			...
			if (talloc_reference(object->job, pytalloc_get_mem_ctx(PyList_GET_ITEM(value, job_cntr_0))) == NULL) {
				PyErr_NoMemory();
				return -1;
			}
			object->job[job_cntr_0] = *(struct rap_PrintJobInfo1 *)pytalloc_get_ptr(PyList_GET_ITEM(value, job_cntr_0));
		}
	}
	return 0;
}
...
{
	return pytalloc_new(struct rap_PrintQueue2, type);
}
...
{
	struct rap_PrintQueue3 *object = (struct rap_PrintQueue3 *)pytalloc_get_ptr(obj);
...
{
	struct rap_PrintQueue3 *object = (struct rap_PrintQueue3 *)pytalloc_get_ptr(py_obj);
	if (value == Py_None) {
		object->PrintQueueName = NULL;
	} else {
		object->PrintQueueName = NULL;
		object->PrintQueueName = talloc_strdup(pytalloc_get_mem_ctx(py_obj), PyString_AS_STRING(value));
	}
	return 0;
}
...
static int py_rap_PrintQueue3_set_Printers(PyObject *py_obj, PyObject *value, void *closure)
{
	...
	if (value == Py_None) {
		...
		object->Printers = NULL;
		object->Printers = talloc_strdup(pytalloc_get_mem_ctx(py_obj), PyString_AS_STRING(value));
	}
	return 0;
}
...
static int py_rap_PrintQueue3_set_PrintDriverData(PyObject *py_obj, PyObject *value, void *closure)
{
	...
	if (value == Py_None) {
		...
		object->PrintDriverData = NULL;
		object->PrintDriverData = talloc_strdup(pytalloc_get_mem_ctx(py_obj), PyString_AS_STRING(value));
	}
	return 0;
}
...
{
	return pytalloc_new(struct rap_PrintQueue3, type);
}
...
static PyObject *py_rap_PrintQueue3_ndr_pack(PyObject *py_obj)
{
	...
	err = ndr_push_struct_blob(&blob, pytalloc_get_mem_ctx(py_obj), object, (ndr_push_flags_fn_t)ndr_push_rap_PrintQueue3);
...
static PyObject *py_rap_PrintQueue3_ndr_unpack(PyObject *py_obj, PyObject *args, PyObject *kwargs)
{
	struct rap_PrintQueue3 *object = (struct rap_PrintQueue3 *)pytalloc_get_ptr(py_obj);
	DATA_BLOB blob;
	int blob_length = 0;
	...
	if (allow_remaining) {
		err = ndr_pull_struct_blob(&blob, pytalloc_get_mem_ctx(py_obj), object, (ndr_pull_flags_fn_t)ndr_pull_rap_PrintQueue3);
	} else {
		err = ndr_pull_struct_blob_all(&blob, pytalloc_get_mem_ctx(py_obj), object, (ndr_pull_flags_fn_t)ndr_pull_rap_PrintQueue3);
	}
	if (err != NDR_ERR_SUCCESS) {
		PyErr_SetNdrError(err);
		return NULL;
...
static PyObject *py_rap_PrintQueue3_ndr_print(PyObject *py_obj)
{
	...
	retstr = ndr_print_struct_string(pytalloc_get_mem_ctx(py_obj), (ndr_print_fn_t)ndr_print_rap_PrintQueue3, "rap_PrintQueue3", object);
...
static PyMethodDef py_rap_PrintQueue3_methods[] = {
	...
	{ "__ndr_unpack__", (PyCFunction)py_rap_PrintQueue3_ndr_unpack, METH_VARARGS|METH_KEYWORDS, "S.ndr_unpack(class, blob, allow_remaining=False) -> None\nNDR unpack" },
...
{
	struct rap_PrintQueue4 *object = (struct rap_PrintQueue4 *)pytalloc_get_ptr(obj);
	PyObject *py_queue;
	py_queue = pytalloc_reference_ex(&rap_PrintQueue3_Type, pytalloc_get_mem_ctx(obj), &object->queue);
	return py_queue;
}

static int py_rap_PrintQueue4_set_queue(PyObject *py_obj, PyObject *value, void *closure)
{
	struct rap_PrintQueue4 *object = (struct rap_PrintQueue4 *)pytalloc_get_ptr(py_obj);
	PY_CHECK_TYPE(&rap_PrintQueue3_Type, value, return -1;);
	if (talloc_reference(pytalloc_get_mem_ctx(py_obj), pytalloc_get_mem_ctx(value)) == NULL) {
		PyErr_NoMemory();
		return -1;
	}
	object->queue = *(struct rap_PrintQueue3 *)pytalloc_get_ptr(value);
	return 0;
}
...
static PyObject *py_rap_PrintQueue4_get_job(PyObject *obj, void *closure)
{
	...
	}
	{
		...
		for (job_cntr_0 = 0; job_cntr_0 < object->queue.PrintJobCount; job_cntr_0++) {
			PyObject *py_job_0;
			py_job_0 = pytalloc_reference_ex(&rap_PrintJobInfo2_Type, object->job, &object->job[job_cntr_0]);
			PyList_SetItem(py_job, job_cntr_0, py_job_0);
		}
	}
	return py_job;
...
static int py_rap_PrintQueue4_set_job(PyObject *py_obj, PyObject *value, void *closure)
{
	...
	PY_CHECK_TYPE(&PyList_Type, value, return -1;);
	{
		...
		for (job_cntr_0 = 0; job_cntr_0 < PyList_GET_SIZE(value); job_cntr_0++) {
			...
			object->job[job_cntr_0] = *(struct rap_PrintJobInfo2 *)pytalloc_get_ptr(PyList_GET_ITEM(value, job_cntr_0));
		}
	}
	return 0;
}
...
{
	return pytalloc_new(struct rap_PrintQueue4, type);
}
...
{
	struct rap_PrintQueue5 *object = (struct rap_PrintQueue5 *)pytalloc_get_ptr(obj);
	PyObject *py_PrintQueueName;
	if (object->PrintQueueName == NULL) {
		py_PrintQueueName = Py_None;
		Py_INCREF(py_PrintQueueName);
...
{
	struct rap_PrintQueue5 *object = (struct rap_PrintQueue5 *)pytalloc_get_ptr(py_obj);
	if (value == Py_None) {
		object->PrintQueueName = NULL;
	} else {
		object->PrintQueueName = NULL;
...
{
	return pytalloc_new(struct rap_PrintQueue5, type);
}
...
PyObject *py_import_rap_printq_info(TALLOC_CTX *mem_ctx, int level, union rap_printq_info *in)
{
	...
	switch (level) {
		case 0:
			ret = pytalloc_reference_ex(&rap_PrintQueue0_Type, mem_ctx, &in->info0);
			return ret;

		case 1:
			ret = pytalloc_reference_ex(&rap_PrintQueue1_Type, mem_ctx, &in->info1);
			return ret;

		case 2:
			ret = pytalloc_reference_ex(&rap_PrintQueue2_Type, mem_ctx, &in->info2);
			return ret;

		case 3:
			ret = pytalloc_reference_ex(&rap_PrintQueue3_Type, mem_ctx, &in->info3);
			return ret;

		case 4:
			ret = pytalloc_reference_ex(&rap_PrintQueue4_Type, mem_ctx, &in->info4);
			return ret;

		case 5:
			ret = pytalloc_reference_ex(&rap_PrintQueue5_Type, mem_ctx, &in->info5);
			return ret;
...
union rap_printq_info *py_export_rap_printq_info(TALLOC_CTX *mem_ctx, int level, PyObject *in)
{
	...
	switch (level) {
		case 0:
			...
			ret->info0 = *(struct rap_PrintQueue0 *)pytalloc_get_ptr(in);
			break;
		...
		case 1:
			...
			ret->info1 = *(struct rap_PrintQueue1 *)pytalloc_get_ptr(in);
			break;
		...
		case 2:
			...
			ret->info2 = *(struct rap_PrintQueue2 *)pytalloc_get_ptr(in);
			break;
		...
		case 3:
			...
			ret->info3 = *(struct rap_PrintQueue3 *)pytalloc_get_ptr(in);
			break;
		...
		case 4:
			...
			ret->info4 = *(struct rap_PrintQueue4 *)pytalloc_get_ptr(in);
			break;
		...
		case 5:
			...
			ret->info5 = *(struct rap_PrintQueue5 *)pytalloc_get_ptr(in);
			break;
...
{
	struct rap_PrintDest0 *object = (struct rap_PrintDest0 *)pytalloc_get_ptr(obj);
...
{
	struct rap_PrintDest0 *object = (struct rap_PrintDest0 *)pytalloc_get_ptr(py_obj);
	if (PyUnicode_Check(value)) {
...
{
	return pytalloc_new(struct rap_PrintDest0, type);
}
...
{
	struct rap_PrintDest1 *object = (struct rap_PrintDest1 *)pytalloc_get_ptr(obj);
	PyObject *py_PrintDestName;
	if (object->PrintDestName == NULL) {
		py_PrintDestName = Py_None;
		Py_INCREF(py_PrintDestName);
...
{
	struct rap_PrintDest1 *object = (struct rap_PrintDest1 *)pytalloc_get_ptr(py_obj);
	if (PyUnicode_Check(value)) {
		object->PrintDestName = PyString_AS_STRING(PyUnicode_AsEncodedString(value, "utf-8", "ignore"));
	} else if (PyString_Check(value)) {
		object->PrintDestName = PyString_AS_STRING(value);
...
static int py_rap_PrintDest1_set_StatusStringName(PyObject *py_obj, PyObject *value, void *closure)
{
	...
	if (value == Py_None) {
		...
		object->StatusStringName = NULL;
		object->StatusStringName = talloc_strdup(pytalloc_get_mem_ctx(py_obj), PyString_AS_STRING(value));
	}
	return 0;
}
...
{
	return pytalloc_new(struct rap_PrintDest1, type);
}
...
{
	struct rap_PrintDest2 *object = (struct rap_PrintDest2 *)pytalloc_get_ptr(obj);
...
{
	struct rap_PrintDest2 *object = (struct rap_PrintDest2 *)pytalloc_get_ptr(py_obj);
	if (value == Py_None) {
...
{
	return pytalloc_new(struct rap_PrintDest2, type);
}
...
{
	struct rap_PrintDest3 *object = (struct rap_PrintDest3 *)pytalloc_get_ptr(obj);
	PyObject *py_PrinterName;
	if (object->PrinterName == NULL) {
		py_PrinterName = Py_None;
		Py_INCREF(py_PrinterName);
...
{
	struct rap_PrintDest3 *object = (struct rap_PrintDest3 *)pytalloc_get_ptr(py_obj);
	if (value == Py_None) {
		object->PrinterName = NULL;
	} else {
		object->PrinterName = NULL;
...
static int py_rap_PrintDest3_set_LogAddr(PyObject *py_obj, PyObject *value, void *closure)
{
	...
	if (value == Py_None) {
		...
		object->LogAddr = NULL;
		object->LogAddr = talloc_strdup(pytalloc_get_mem_ctx(py_obj), PyString_AS_STRING(value));
	}
	return 0;
}
...
static int py_rap_PrintDest3_set_Drivers(PyObject *py_obj, PyObject *value, void *closure)
{
	...
	if (value == Py_None) {
		...
		object->Drivers = NULL;
		object->Drivers = talloc_strdup(pytalloc_get_mem_ctx(py_obj), PyString_AS_STRING(value));
	}
	return 0;
}
...
{
	return pytalloc_new(struct rap_PrintDest3, type);
}
...
PyObject *py_import_rap_printdest_info(TALLOC_CTX *mem_ctx, int level, union rap_printdest_info *in)
{
	...
	switch (level) {
		case 0:
			ret = pytalloc_reference_ex(&rap_PrintDest0_Type, mem_ctx, &in->info0);
			return ret;

		case 1:
			ret = pytalloc_reference_ex(&rap_PrintDest1_Type, mem_ctx, &in->info1);
			return ret;

		case 2:
			ret = pytalloc_reference_ex(&rap_PrintDest2_Type, mem_ctx, &in->info2);
			return ret;

		case 3:
			ret = pytalloc_reference_ex(&rap_PrintDest3_Type, mem_ctx, &in->info3);
			return ret;
...
union rap_printdest_info *py_export_rap_printdest_info(TALLOC_CTX *mem_ctx, int level, PyObject *in)
{
	...
	switch (level) {
		case 0:
			...
			ret->info0 = *(struct rap_PrintDest0 *)pytalloc_get_ptr(in);
			break;
		...
		case 1:
			...
			ret->info1 = *(struct rap_PrintDest1 *)pytalloc_get_ptr(in);
			break;
		...
		case 2:
			...
			ret->info2 = *(struct rap_PrintDest2 *)pytalloc_get_ptr(in);
			break;
		...
		case 3:
			...
			ret->info3 = *(struct rap_PrintDest3 *)pytalloc_get_ptr(in);
			break;
...
{
	struct rap_NetUserInfo0 *object = (struct rap_NetUserInfo0 *)pytalloc_get_ptr(obj);
	PyObject *py_Name;
	if (object->Name == NULL) {
		py_Name = Py_None;
		Py_INCREF(py_Name);
...
{
	struct rap_NetUserInfo0 *object = (struct rap_NetUserInfo0 *)pytalloc_get_ptr(py_obj);
	if (PyUnicode_Check(value)) {
...
{
	return pytalloc_new(struct rap_NetUserInfo0, type);
}
...
{
	struct rap_NetUserInfo1 *object = (struct rap_NetUserInfo1 *)pytalloc_get_ptr(obj);
	PyObject *py_Name;
	if (object->Name == NULL) {
		py_Name = Py_None;
		Py_INCREF(py_Name);
...
{
	struct rap_NetUserInfo1 *object = (struct rap_NetUserInfo1 *)pytalloc_get_ptr(py_obj);
	if (PyUnicode_Check(value)) {
		object->Name = PyString_AS_STRING(PyUnicode_AsEncodedString(value, "utf-8", "ignore"));
	} else if (PyString_Check(value)) {
		object->Name = PyString_AS_STRING(value);
...
static int py_rap_NetUserInfo1_set_HomeDir(PyObject *py_obj, PyObject *value, void *closure)
{
	...
	if (value == Py_None) {
		...
		object->HomeDir = NULL;
		object->HomeDir = talloc_strdup(pytalloc_get_mem_ctx(py_obj), PyString_AS_STRING(value));
	}
	return 0;
}
...
static int py_rap_NetUserInfo1_set_ScriptPath(PyObject *py_obj, PyObject *value, void *closure)
{
	...
	if (value == Py_None) {
		...
		object->ScriptPath = NULL;
		object->ScriptPath = talloc_strdup(pytalloc_get_mem_ctx(py_obj), PyString_AS_STRING(value));
	}
	return 0;
}
...
{
	return pytalloc_new(struct rap_NetUserInfo1, type);
}
...
{
	struct rap_LogonHours *object = (struct rap_LogonHours *)pytalloc_get_ptr(obj);
...
{
	struct rap_LogonHours *object = (struct rap_LogonHours *)pytalloc_get_ptr(py_obj);
	PY_CHECK_TYPE(&PyList_Type, value, return -1;);
	{
		int LogonHours_cntr_0;
...
{
	return pytalloc_new(struct rap_LogonHours, type);
}
...
static PyObject *py_rap_LogonHours_ndr_pack(PyObject *py_obj)
{
	...
	DATA_BLOB blob;
	enum ndr_err_code err;
	err = ndr_push_struct_blob(&blob, pytalloc_get_mem_ctx(py_obj), object, (ndr_push_flags_fn_t)ndr_push_rap_LogonHours);
	if (err != NDR_ERR_SUCCESS) {
		PyErr_SetNdrError(err);
		return NULL;
	}
...
static PyObject *py_rap_LogonHours_ndr_unpack(PyObject *py_obj, PyObject *args, PyObject *kwargs)
{
	struct rap_LogonHours *object = (struct rap_LogonHours *)pytalloc_get_ptr(py_obj);
	DATA_BLOB blob;
	int blob_length = 0;
	...
	if (allow_remaining) {
		err = ndr_pull_struct_blob(&blob, pytalloc_get_mem_ctx(py_obj), object, (ndr_pull_flags_fn_t)ndr_pull_rap_LogonHours);
	} else {
		err = ndr_pull_struct_blob_all(&blob, pytalloc_get_mem_ctx(py_obj), object, (ndr_pull_flags_fn_t)ndr_pull_rap_LogonHours);
	}
	if (err != NDR_ERR_SUCCESS) {
		PyErr_SetNdrError(err);
		return NULL;
...
static PyObject *py_rap_LogonHours_ndr_print(PyObject *py_obj)
{
	...
	retstr = ndr_print_struct_string(pytalloc_get_mem_ctx(py_obj), (ndr_print_fn_t)ndr_print_rap_LogonHours, "rap_LogonHours", object);
	ret = PyString_FromString(retstr);
	talloc_free(retstr);
...
static PyMethodDef py_rap_LogonHours_methods[] = {
	...
	{ "__ndr_unpack__", (PyCFunction)py_rap_LogonHours_ndr_unpack, METH_VARARGS|METH_KEYWORDS, "S.ndr_unpack(class, blob, allow_remaining=False) -> None\nNDR unpack" },
...
{
	struct rap_NetUserInfo2 *object = (struct rap_NetUserInfo2 *)pytalloc_get_ptr(obj);
	PyObject *py_Name;
	if (object->Name == NULL) {
		py_Name = Py_None;
		Py_INCREF(py_Name);
...
{
	struct rap_NetUserInfo2 *object = (struct rap_NetUserInfo2 *)pytalloc_get_ptr(py_obj);
	if (PyUnicode_Check(value)) {
		object->Name = PyString_AS_STRING(PyUnicode_AsEncodedString(value, "utf-8", "ignore"));
	} else if (PyString_Check(value)) {
		object->Name = PyString_AS_STRING(value);
...
static int py_rap_NetUserInfo2_set_FullName(PyObject *py_obj, PyObject *value, void *closure)
{
	...
	if (value == Py_None) {
		...
		object->FullName = NULL;
		object->FullName = talloc_strdup(pytalloc_get_mem_ctx(py_obj), PyString_AS_STRING(value));
	}
	return 0;
}
...
static int py_rap_NetUserInfo2_set_UsrComment(PyObject *py_obj, PyObject *value, void *closure)
{
	...
	if (value == Py_None) {
		...
		object->UsrComment = NULL;
		object->UsrComment = talloc_strdup(pytalloc_get_mem_ctx(py_obj), PyString_AS_STRING(value));
	}
	return 0;
}
...
static int py_rap_NetUserInfo2_set_pParms(PyObject *py_obj, PyObject *value, void *closure)
{
	...
	if (value == Py_None) {
		...
		object->pParms = NULL;
		object->pParms = talloc_strdup(pytalloc_get_mem_ctx(py_obj), PyString_AS_STRING(value));
	}
	return 0;
}
...
static int py_rap_NetUserInfo2_set_WorkStations(PyObject *py_obj, PyObject *value, void *closure)
{
	...
	if (value == Py_None) {
		...
		object->WorkStations = NULL;
		object->WorkStations = talloc_strdup(pytalloc_get_mem_ctx(py_obj), PyString_AS_STRING(value));
	}
	return 0;
}
...
static PyObject *py_rap_NetUserInfo2_get_LogonHours(PyObject *obj, void *closure)
{
	...
	if (object->LogonHours == NULL) {
		...
		py_LogonHours = pytalloc_reference_ex(&rap_LogonHours_Type, object->LogonHours, object->LogonHours);
	}
	return py_LogonHours;
}
...
{
	struct rap_NetUserInfo2 *object = (struct rap_NetUserInfo2 *)pytalloc_get_ptr(py_obj);
	talloc_unlink(pytalloc_get_mem_ctx(py_obj), object->LogonHours);
	if (value == Py_None) {
		...
		object->LogonHours = (struct rap_LogonHours *)pytalloc_get_ptr(value);
	}
	return 0;
}
...
static int py_rap_NetUserInfo2_set_LogonServer(PyObject *py_obj, PyObject *value, void *closure)
{
	...
	if (value == Py_None) {
		...
		object->LogonServer = NULL;
		object->LogonServer = talloc_strdup(pytalloc_get_mem_ctx(py_obj), PyString_AS_STRING(value));
	}
	return 0;
}
...
{
	return pytalloc_new(struct rap_NetUserInfo2, type);
}
...
{
	struct rap_NetUserInfo10 *object = (struct rap_NetUserInfo10 *)pytalloc_get_ptr(obj);
	PyObject *py_Name;
	if (object->Name == NULL) {
		py_Name = Py_None;
		Py_INCREF(py_Name);
...
{
	struct rap_NetUserInfo10 *object = (struct rap_NetUserInfo10 *)pytalloc_get_ptr(py_obj);
	if (PyUnicode_Check(value)) {
		object->Name = PyString_AS_STRING(PyUnicode_AsEncodedString(value, "utf-8", "ignore"));
	} else if (PyString_Check(value)) {
		object->Name = PyString_AS_STRING(value);
...
{
	return pytalloc_new(struct rap_NetUserInfo10, type);
}
...
{
	struct rap_NetUserInfo11 *object = (struct rap_NetUserInfo11 *)pytalloc_get_ptr(obj);
	PyObject *py_Name;
	if (object->Name == NULL) {
		py_Name = Py_None;
		Py_INCREF(py_Name);
...
{
	struct rap_NetUserInfo11 *object = (struct rap_NetUserInfo11 *)pytalloc_get_ptr(py_obj);
	if (PyUnicode_Check(value)) {
		object->Name = PyString_AS_STRING(PyUnicode_AsEncodedString(value, "utf-8", "ignore"));
	} else if (PyString_Check(value)) {
		object->Name = PyString_AS_STRING(value);
...
static int py_rap_NetUserInfo11_set_Parms(PyObject *py_obj, PyObject *value, void *closure)
{
	...
	if (value == Py_None) {
		...
		object->Parms = NULL;
		object->Parms = talloc_strdup(pytalloc_get_mem_ctx(py_obj), PyString_AS_STRING(value));
	}
	return 0;
}
...
{
	return pytalloc_new(struct rap_NetUserInfo11, type);
}
...
PyObject *py_import_rap_netuser_info(TALLOC_CTX *mem_ctx, int level, union rap_netuser_info *in)
{
	...
	switch (level) {
		case 0:
			ret = pytalloc_reference_ex(&rap_NetUserInfo0_Type, mem_ctx, &in->info0);
			return ret;

		case 1:
			ret = pytalloc_reference_ex(&rap_NetUserInfo1_Type, mem_ctx, &in->info1);
			return ret;

		case 2:
			ret = pytalloc_reference_ex(&rap_NetUserInfo2_Type, mem_ctx, &in->info2);
			return ret;

		case 10:
			ret = pytalloc_reference_ex(&rap_NetUserInfo10_Type, mem_ctx, &in->info10);
			return ret;

		case 11:
			ret = pytalloc_reference_ex(&rap_NetUserInfo11_Type, mem_ctx, &in->info11);
			return ret;
...
union rap_netuser_info *py_export_rap_netuser_info(TALLOC_CTX *mem_ctx, int level, PyObject *in)
{
	...
	switch (level) {
		case 0:
			...
			ret->info0 = *(struct rap_NetUserInfo0 *)pytalloc_get_ptr(in);
			break;
		...
		case 1:
			...
			ret->info1 = *(struct rap_NetUserInfo1 *)pytalloc_get_ptr(in);
			break;
		...
		case 2:
			...
			ret->info2 = *(struct rap_NetUserInfo2 *)pytalloc_get_ptr(in);
			break;
		...
		case 10:
			...
			ret->info10 = *(struct rap_NetUserInfo10 *)pytalloc_get_ptr(in);
			break;
		...
		case 11:
			...
			ret->info11 = *(struct rap_NetUserInfo11 *)pytalloc_get_ptr(in);
			break;
...
{
	struct rap_session_info_2 *object = (struct rap_session_info_2 *)pytalloc_get_ptr(obj);
...
{
	struct rap_session_info_2 *object = (struct rap_session_info_2 *)pytalloc_get_ptr(py_obj);
	if (value == Py_None) {
...
static int py_rap_session_info_2_set_CliTypeName(PyObject *py_obj, PyObject *value, void *closure)
{
	...
	if (value == Py_None) {
		...
		object->CliTypeName = NULL;
		object->CliTypeName = talloc_strdup(pytalloc_get_mem_ctx(py_obj), PyString_AS_STRING(value));
	}
	return 0;
}
...
{
	return pytalloc_new(struct rap_session_info_2, type);
}
...
PyObject *py_import_rap_session_info(TALLOC_CTX *mem_ctx, int level, union rap_session_info *in)
{
	...
	switch (level) {
		case 2:
			ret = pytalloc_reference_ex(&rap_session_info_2_Type, mem_ctx, &in->info2);
			return ret;
...
union rap_session_info *py_export_rap_session_info(TALLOC_CTX *mem_ctx, int level, PyObject *in)
{
	...
	switch (level) {
		case 2:
			...
			ret->info2 = *(struct rap_session_info_2 *)pytalloc_get_ptr(in);
			break;
...
{
	struct rap_TimeOfDayInfo *object = (struct rap_TimeOfDayInfo *)pytalloc_get_ptr(obj);
...
{
	struct rap_TimeOfDayInfo *object = (struct rap_TimeOfDayInfo *)pytalloc_get_ptr(py_obj);
	PY_CHECK_TYPE(&PyInt_Type, value, return -1;);
...
{
	return pytalloc_new(struct rap_TimeOfDayInfo, type);
}
...
static PyObject *py_rap_TimeOfDayInfo_ndr_pack(PyObject *py_obj)
{
	...
	DATA_BLOB blob;
	enum ndr_err_code err;
	err = ndr_push_struct_blob(&blob, pytalloc_get_mem_ctx(py_obj), object, (ndr_push_flags_fn_t)ndr_push_rap_TimeOfDayInfo);
	if (err != NDR_ERR_SUCCESS) {
		PyErr_SetNdrError(err);
		return NULL;
	}
...
static PyObject *py_rap_TimeOfDayInfo_ndr_unpack(PyObject *py_obj, PyObject *args, PyObject *kwargs)
{
	struct rap_TimeOfDayInfo *object = (struct rap_TimeOfDayInfo *)pytalloc_get_ptr(py_obj);
	DATA_BLOB blob;
	int blob_length = 0;
	...
	if (allow_remaining) {
		err = ndr_pull_struct_blob(&blob, pytalloc_get_mem_ctx(py_obj), object, (ndr_pull_flags_fn_t)ndr_pull_rap_TimeOfDayInfo);
	} else {
		err = ndr_pull_struct_blob_all(&blob, pytalloc_get_mem_ctx(py_obj), object, (ndr_pull_flags_fn_t)ndr_pull_rap_TimeOfDayInfo);
	}
	if (err != NDR_ERR_SUCCESS) {
		PyErr_SetNdrError(err);
		return NULL;
...
static PyObject *py_rap_TimeOfDayInfo_ndr_print(PyObject *py_obj)
{
	...
	retstr = ndr_print_struct_string(pytalloc_get_mem_ctx(py_obj), (ndr_print_fn_t)ndr_print_rap_TimeOfDayInfo, "rap_TimeOfDayInfo", object);
	ret = PyString_FromString(retstr);
	talloc_free(retstr);
...
static PyMethodDef py_rap_TimeOfDayInfo_methods[] = {
	...
	{ "__ndr_unpack__", (PyCFunction)py_rap_TimeOfDayInfo_ndr_unpack, METH_VARARGS|METH_KEYWORDS, "S.ndr_unpack(class, blob, allow_remaining=False) -> None\nNDR unpack" },
